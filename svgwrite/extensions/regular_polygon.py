...
class RegularPolygonFactory(object):
    """
    Extension to support creation of regular polygons
    """
    def __init__(self, drawing):
        self.svg = drawing

    def get(self, num_corners, edge_length, center=(0,0), **extra):
        ...
        for co in range(num_corners - 1):
            ...
            points.append((x,y))
        return self.svg.polygon(points, **extra)
